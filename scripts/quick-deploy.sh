...
# Quick deployment script for ijuloss/weather-station-server

set -e

echo "=========================================="
echo "  WEATHER STATION DEPLOYMENT"
echo "  From GitHub: ijuloss/weather-station-server"
echo "=========================================="
...
echo "Repository: https://github.com/ijuloss/weather-station-server"
echo ""
...
git clone https://github.com/ijuloss/weather-station-server.git /opt/weather-station
...
sudo -u weatherstation /opt/weather-station/venv/bin/pip install \
    flask \
    flask-cors \
    requests \
    scikit-learn \
...
print_header "STEP 9: Enable and Start Service"
